...
# from collectors import telegram


class App(AppBaseTemplate):
    def __init__(self):
        self.logger = mt5.get_logger(path_to_logfile='mt5_log.log',
                                     loglevel=logging.INFO, time_utc=True)
        self.mt5_connected = mt5.connected(
            path=r'C:/Program Files/MetaTrader 5/terminal64.exe',
            # path=r'/home/seekersoftec/Documents/Tech/Fortesense Labs/Financial_Eng/Financial Markets/lab/Metatrader5-Docker/Metatrader/terminal64.exe',
            portable=True,
            server='Deriv-Demo',
            login=21193089,  # financial => 21193089 | synthetic => 21085818
            password='@Ssc21707232',
            timeout=5000,
    ...
    def start(self):
        ...
        with self.mt5_connected as conn:
            try:
                ...
                # sym_name = "BTCUSD"  # "Crash 1000 Index", "EURUSD"
