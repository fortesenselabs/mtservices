...
from application.exchange_interfaces.metatrader.timeframes import TimeFrames
...
class Rates:
    ...
    def get_rates_from_index(self, symbol_pair: str = "GBPUSD", timeframe: str = TimeFrames.TIMEFRAME_D1, start_index: int = 0, count: int = 10) -> pd.DataFrame:
        """
            Get bars from the MetaTrader 5 terminal starting from the specified index
        """
        # get 10 GBPUSD D1 bars from the current day
        rates = self.copy_rates_from_pos(
