CREATE DATABASE IF NOT EXISTS bitspend01_testdb CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE bitspend01_testdb;
...
CREATE TABLE fiat_transactions (
  ...
  status ENUM('SUCCESSFUL', 'PROCESSING', 'PENDING', 'CANCELLED', 'FATAL_ERROR', 'REQUEST_TIMEOUT', 'FAILED') NOT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
INSERT INTO users (id, email, first_name, last_name, hash_password, is_token, country, phone_number, role, is_active, is_deleted, wallet_created, created_at, updated_at)
VALUES (UUID(), 'admin@example.com', 'Admin', 'User', '$2b$10$Gv2cJh5qGZU2k9FO.jPq/O1EvRhFa5/SRIQ1eVadRxxQA6RigR4ju', false, 'USA', '+1234567890', 'admin', true, false, false, NOW(), NOW());
