...
import pytz
from Pytrader import PyTraderAPI
...
Connected = MT.Connect(
    server='127.0.0.1',
    port=1122, #1122, | 1111
    authorization_code='123456',  # '123456' is the default code in the EA
...
# StaticInfo = dictionary
StaticInfo = MT.Get_account_info()
...
# DynamicInfo = dictionary
# DynamicInfo = MT.Get_balance_info()
...
# # InstrumentInfo = dictionary, if instrument not known at broker the
