# [program:mtwebserver]
# command=/usr/local/bin/python /root/MTWebServer/app.py
# directory=/root/MTWebServer
# autostart=true
# autorestart=true
# stdout_logfile=/dev/fd/1
# stdout_logfile_maxbytes=0
# stdout_logfile=/var/log/mtwebserver.log
# stderr_logfile=/var/log/mtwebserver.err.log
# 
# 
...
# FROM amancevice/pandas:alpine as pandas-builder

# RUN pip install ejtraderMT
...
# # Copy pandas-builder image to zmq-builder image
# COPY --from=pandas-builder / /
...
# # COPY ZeroMQService /root/ZeroMQService
...
# RUN pip install --no-cache-dir -r /root/MTWebServer/requirements.txt

# # EXPOSE 5900 15555 15556 15557 15558
# EXPOSE 5900 $WEB_SERVER_PORT
