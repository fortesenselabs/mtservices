...
# RUN apk add --no-cache libgfortran gfortran
# RUN apk add --update py3-numpy@community 
#py3-pandas@community
# python3 python3-dev gfortran py3-pip build-base 
# COPY --from=lock /var/lib/pandas/ /var/lib/pandas/
# COPY --from=lock /usr/local/lib/python3.7/site-packages/ /usr/local/lib/python3.7/site-packages/ 
