...
import re
import asyncio
from application.investor.investor import TradingManager
from application.data_interfaces.metatrader import Rates, Symbols, AccountInfo, BaseCollector, Order
# import pytz
...
class MetaTraderInterface:
    def __init__(self, login="...", password="...", server="...", terminal_path: str = r"C:/Metatrader5/terminal64.exe", portable: bool = True):
